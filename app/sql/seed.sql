...
VALUES
  ('DevTool Pro', 'The ultimate developer toolkit', 'Comprehensive development suite', 'Easy integration with existing workflow', '/icons/devtool.png', 'https://devtool.pro', '{"views": 0, "reviews": 0}', '94ce54f6-4277-40ea-8bd5-2c8f016a04cd', 1, NOW(), NOW()),
  ('DesignMaster', 'Design like a pro', 'Professional design platform', 'Intuitive interface for designers', '/icons/design.png', 'https://designmaster.app', '{"views": 0, "reviews": 0}', '94ce54f6-4277-40ea-8bd5-2c8f016a04cd', 2, NOW(), NOW()),
  ('MarketGenius', 'Smart marketing automation', 'AI-powered marketing platform', 'Automated marketing workflows', '/icons/market.png', 'https://marketgenius.io', '{"views": 0, "reviews": 0}', '94ce54f6-4277-40ea-8bd5-2c8f016a04cd', 3, NOW(), NOW()),
  ('CodeBuddy', 'Your coding companion', 'AI pair programming assistant', 'Real-time code suggestions', '/icons/code.png', 'https://codebuddy.dev', '{"views": 0, "reviews": 0}', '94ce54f6-4277-40ea-8bd5-2c8f016a04cd', 4, NOW(), NOW()),
  ('DataViz', 'Beautiful data visualization', 'Turn data into insights', 'Drag-and-drop visualization builder', '/icons/dataviz.png', 'https://dataviz.app', '{"views": 0, "reviews": 0}', '94ce54f6-4277-40ea-8bd5-2c8f016a04cd', 5, NOW(), NOW());

-- Seed product upvotes (bridge table)
INSERT INTO product_upvotes (product_id, profile_id)
VALUES (11, '94ce54f6-4277-40ea-8bd5-2c8f016a04cd');

-- Seed reviews
INSERT INTO reviews (product_id, profile_id, rating, review, created_at, updated_at)
VALUES
  (11, '94ce54f6-4277-40ea-8bd5-2c8f016a04cd', 5, 'Excellent developer tool!', NOW(), NOW()),
  (12, '94ce54f6-4277-40ea-8bd5-2c8f016a04cd', 4, 'Great design features', NOW(), NOW()),
  (13, '94ce54f6-4277-40ea-8bd5-2c8f016a04cd', 5, 'Amazing marketing automation', NOW(), NOW()),
  (14, '94ce54f6-4277-40ea-8bd5-2c8f016a04cd', 4, 'Very helpful coding assistant', NOW(), NOW()),
  (15, '94ce54f6-4277-40ea-8bd5-2c8f016a04cd', 5, 'Powerful visualization tool', NOW(), NOW());
...
VALUES
  ('Getting Started with DevTool Pro', 'A comprehensive guide to DevTool Pro...', 1, '94ce54f6-4277-40ea-8bd5-2c8f016a04cd', NOW(), NOW()),
  ('Design Tips and Tricks', 'Essential design principles...', 2, '94ce54f6-4277-40ea-8bd5-2c8f016a04cd', NOW(), NOW()),
  ('Marketing Automation Best Practices', 'How to automate your marketing...', 3, '94ce54f6-4277-40ea-8bd5-2c8f016a04cd', NOW(), NOW()),
  ('Launching Your First Product', 'Steps to a successful product launch...', 4, '94ce54f6-4277-40ea-8bd5-2c8f016a04cd', NOW(), NOW()),
  ('AI in Modern Development', 'How AI is changing development...', 5, '94ce54f6-4277-40ea-8bd5-2c8f016a04cd', NOW(), NOW());

-- Seed post upvotes (bridge table)
INSERT INTO post_upvotes (post_id, profile_id)
VALUES (1, '94ce54f6-4277-40ea-8bd5-2c8f016a04cd');

-- Seed post replies
INSERT INTO post_replies (post_id, profile_id, reply, created_at, updated_at)
VALUES
  (1, '94ce54f6-4277-40ea-8bd5-2c8f016a04cd', 'Great post about DevTool Pro!', NOW(), NOW()),
  (2, '94ce54f6-4277-40ea-8bd5-2c8f016a04cd', 'These design tips are very helpful', NOW(), NOW()),
  (3, '94ce54f6-4277-40ea-8bd5-2c8f016a04cd', 'Marketing automation is crucial', NOW(), NOW()),
  (4, '94ce54f6-4277-40ea-8bd5-2c8f016a04cd', 'Launch strategy is on point', NOW(), NOW()),
  (5, '94ce54f6-4277-40ea-8bd5-2c8f016a04cd', 'AI is indeed transforming development', NOW(), NOW());

-- Seed gpt ideas
INSERT INTO gpt_ideas (idea, views, claimed_by, created_at)
VALUES
  ('AI-powered code review assistant', 0, '94ce54f6-4277-40ea-8bd5-2c8f016a04cd', NOW()),
...
VALUES (1, '94ce54f6-4277-40ea-8bd5-2c8f016a04cd', NOW());

-- Seed messages
INSERT INTO messages (message_room_id, sender_id, content, created_at)
VALUES
  (1, '94ce54f6-4277-40ea-8bd5-2c8f016a04cd', 'Hello! Interested in collaboration', NOW()),
  (1, '94ce54f6-4277-40ea-8bd5-2c8f016a04cd', 'Let''s discuss the project details', NOW()),
  (1, '94ce54f6-4277-40ea-8bd5-2c8f016a04cd', 'What''s your availability?', NOW()),
  (1, '94ce54f6-4277-40ea-8bd5-2c8f016a04cd', 'I can start next week', NOW()),
  (1, '94ce54f6-4277-40ea-8bd5-2c8f016a04cd', 'Great, looking forward to working together', NOW());

-- Seed notifications
INSERT INTO notifications (source_id, product_id, post_id, target_id, type, created_at)
VALUES
  ('94ce54f6-4277-40ea-8bd5-2c8f016a04cd', 11, NULL, '94ce54f6-4277-40ea-8bd5-2c8f016a04cd', 'review', NOW()),
  ('94ce54f6-4277-40ea-8bd5-2c8f016a04cd', NULL, 1, '94ce54f6-4277-40ea-8bd5-2c8f016a04cd', 'reply', NOW()),
  ('94ce54f6-4277-40ea-8bd5-2c8f016a04cd', NULL, NULL, '94ce54f6-4277-40ea-8bd5-2c8f016a04cd', 'follow', NOW()),
  ('94ce54f6-4277-40ea-8bd5-2c8f016a04cd', NULL, 2, '94ce54f6-4277-40ea-8bd5-2c8f016a04cd', 'mention', NOW()),
  ('94ce54f6-4277-40ea-8bd5-2c8f016a04cd', 12, NULL, '94ce54f6-4277-40ea-8bd5-2c8f016a04cd', 'review', NOW());
